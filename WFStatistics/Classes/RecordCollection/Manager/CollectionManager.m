...
#define CollectionPageListPath [[NSBundle bundleForClass:[self class]] pathForResource:@"CollectionPageList" ofType:@"plist"]

#define CollectionEventListPath [[NSBundle bundleForClass:[self class]] pathForResource:@"CollectionEventList" ofType:@"plist"]
